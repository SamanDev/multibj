...
nickname.setAttribute('value',_username)
...
window.addEventListener("load", (event) => {
  const loc2 = new URL(window.location)
const pathArr2 = loc2.pathname.toString().split("/");
  if(pathArr2.length<3){
